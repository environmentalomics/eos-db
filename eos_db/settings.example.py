...
"""This structure captures the valid Boost states for the system.
...
class BoostStates():
    ...
    """States in order.  Ideally he portal should fetch this list from a public API call.
       In any case the validity of a boost request should be chacked against this table"""
    states = (
        { 'label'  : 'Standard+',
          'ram'    : '40',
          'cores'  : '2',
    ...
    """Capacity table, as determined by abowery.  Each tuple is
        ...
        but on the EOS cloud we assume we can star 20 in total.
    """
    capacity = (
        ( 20,  0,  0 ),
        ( 19,  1,  0 ),
